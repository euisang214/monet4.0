...
export function ZoomLinkForm({ bookingId, initialUrl, initialMeetingId }: { bookingId: string, initialUrl?: string | null, initialMeetingId?: string | null }) {
    ...
    async function handleSubmit(e: React.FormEvent) {
        ...
        try {
            const res = await fetch(`/api/admin/bookings/${bookingId}/zoom-link`, {
                ...
                body: JSON.stringify({ zoomJoinUrl: url, zoomMeetingId: meetingId }),
            });
