# AGENTS.md - Kafei 3.0 Codebase Guide for AI Assistants
...
- **LLM**: Codex API (Anthropic) for automated QC validation
...
- Note: QC is fully automated via Codex API. No manual override endpoint.
...
3. LLM Validation (Codex API)
   → Calls Codex API with feedback text and validation prompt
...
6. Update this AGENTS.md with new endpoint
...
- **Codex Branches**: Auto-generated `Codex/Codex-md-*` branches
...
1. Ensure tests pass
2. Update AGENTS.md if adding new features
...
7. ✅ **Update this AGENTS.md** when adding significant features
...
| 2026-01-17 | Schema fixes (attendanceOutcome, candidateLateCancellation, PaymentStatus.cancelled/capture_failed), QC flow update to LLM-only (Codex API), success fee removal, async confirm-and-schedule pattern, webhook loopback fix |
